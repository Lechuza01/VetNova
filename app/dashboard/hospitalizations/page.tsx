  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-foreground">Internaciones</h1>
          <p className="text-sm md:text-base text-muted-foreground mt-1">Gestión de animales internados</p>
        </div>
